...
public:
    ...
    const double maxVel = 14,minVel = 0;
    ...
    //////////////////////////////////////////////////////
    //////////////////////////////////////////////////////
    vector<double> Lpoint2 = {map.U1[0]-2.5,map.L2[1]-2.5};
    double turnRad = 10;
    double angle = 0;
    //////////////////////////////////////////////////////
    //////////////////////////////////////////////////////
...
void Car::Turn(int turning)
{
    ...
    else if(turnCount == exitCount)
    {
        ...
        else if(2==laneNum)
        {
            ...
            else if(2==turning && Distance({x,y},{Lpoint2})-turnRad < 5*Tol && y>3)
            {
                x = RotatePoint(Lpoint2,{x,y},angle+5)[0];
                y = RotatePoint(Lpoint2,{x,y},angle+5)[1];
...
int main(void)
{
    ...
    for(;;)
    {
        ...
        if(tPassed%7 == 0 && create_car == false){
            cout << "creating a car\n";
            Car* new_car = new Car();
        ...
        if(tPassed%24<6)
        {
            ...
            sig1.leftTurn=false,sig2.leftTurn = false,sig3.leftTurn = false,sig4.leftTurn = false;    
        }
        else if(tPassed%24<12)
        {
            sig1.go = false,sig2.go=false,sig3.go=false,sig4.go=false;
            sig1.leftTurn=true,sig2.leftTurn = true,sig3.leftTurn = false,sig4.leftTurn = false;    
        }
        else if(tPassed%24<18)
        {
        ...
        {
            sig1.go = false,sig2.go=false,sig3.go=false,sig4.go=false;
            sig1.leftTurn=false,sig2.leftTurn = false,sig3.leftTurn = true,sig4.leftTurn = true;    
        }
        ...
        map.DrawTree(15,55);
        map.DrawTree(30,70);
        map.DrawWindMill(70,20);
        map.DrawWindMill(85,30);
