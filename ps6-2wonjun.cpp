...
public:
    ...
    void Draw(void);
    bool checkCollision(double x2, double y2, Ball& ball);
};
...
bool Blocks::checkCollision(double x2, double y2, Ball& ball)
{
...
int main(void)
{
    ...
    for(;;)
    {
        ...
        for(auto &b: blocks)
        {
            if(true== b.checkCollision(ball.x,ball.y,ball))
            {
                ball.vy = - ball.vy;
